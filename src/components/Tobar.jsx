  ...
  return (
    <nav className="navbar bg-base-100  font-normal shadow-md pl-6 fixed top-0 z-50 w-full h-16">
      ...
      <div className="  sm:static sm:block  dropdown dropdown-end">
        ...
        <ul
          className={` sm:flex sm:flex-row  sm:translate-x-0 sm:static sm:opacity-100 sm:px-0 sm:py-0 sm:rounded sm:shadow-none  items-center  md:gap-4 gap-2 transition-all duration-500 bg-base-100  flex flex-col px-12 py-4 rounded-md shadow-md absolute overflow-hidden
                        ${
                          drop === true
